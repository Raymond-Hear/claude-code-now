...
reg add "HKEY_CLASSES_ROOT\Directory\shell\ClaudeCodeNow\command" /ve /d "powershell.exe -ExecutionPolicy Bypass -WindowStyle Hidden -NoProfile -File \"%USERPROFILE%\bin\claude-code-now.ps1\" \"%%V\"" /f >nul
...
reg add "HKEY_CLASSES_ROOT\Directory\Background\shell\ClaudeCodeNow\command" /ve /d "powershell.exe -ExecutionPolicy Bypass -WindowStyle Hidden -NoProfile -File \"%USERPROFILE%\bin\claude-code-now.ps1\" \"%%V\"" /f >nul
...
reg add "HKEY_CLASSES_ROOT\Drive\shell\ClaudeCodeNow\command" /ve /d "powershell.exe -ExecutionPolicy Bypass -WindowStyle Hidden -NoProfile -File \"%USERPROFILE%\bin\claude-code-now.ps1\" \"%%V\"" /f >nul
